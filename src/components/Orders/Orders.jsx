                                ...
                                <tbody>
                                    {
                                        products.map((product) => {
                                            return <tr>
                                                <td>
                                                    <h5 className="font-size-14 text-truncate"><a href="ecommerce-product-detail.html" className="text-dark">{product.name}</a></h5>
                                                    <p className="mb-0">Color : <span className="fw-medium">Maroon</span></p>
                                                </td>
                                                <td>
                                                    {product.price}
                                                </td>
